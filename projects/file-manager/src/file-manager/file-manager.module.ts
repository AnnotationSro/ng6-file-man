...
import * as fromFileManager from "./reducers/stateReducer";
...
@NgModule({
  imports: [
    HttpClientModule,
    StoreModule.forFeature("fileManager", fromFileManager.reducer),
    CommonModule,
  ...
  exports: [FileManagerComponent, LoadingOverlayComponent, SideViewComponent],
